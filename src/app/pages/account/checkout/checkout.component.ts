...
export class CheckoutComponent implements OnInit, OnDestroy{
        ...
        if(this.auth.authenticated){
            ...
            this.auth.getCurrentLogin().subscribe((res) => {
                ...
                if(res.mobile != "0") {
                    ...
                    this.receiverEmailAddr = res.email;
    ...
    placeOrder() {
        ...
        const dateNum = date.toLocaleString('default', { day: 'numeric'});
                            ...
                            this.service.getMerchantHash(hashBody).subscribe((res) => {
                                ...
                                setTimeout(() => {
                                    ...
                                    let handler = PaystackPop.setup({
                                        key: environment.paystack_test_key, // Replace with your public key
                                        email: body.receiverEmail,
                                        amount: body.grandTotal * 100,
                                        ...
                                        callback: function(response){
                                            let message = 'Payment complete! Reference: ' + JSON.stringify(response);
                                            console.log(message);
                                            storedContext.router.navigateByUrl('/payment-verify/' + storedContext.orderId);
                                        }
                                    });
    ...
    paymentDone(ref: any) {
        ...
        this.router.navigateByUrl('/payment-verify/'+this.orderId);
    }
